(function () {
    ...
    app.service('transform', function () {
        ...
        this.make_suits_group_sring_arr = function(dh_grouped) {

            suits_grouped = _.map(dh_grouped1, function (rank_str_set, key) {
                //rank_str_set = dh_grouped1[key];
                //console.log(rank_str_set);
                var self = this;
                var obj = {};
                ...
                obj = {
                    total_prob: [total_numerator, total_denom],
                    rank_str: key,
